...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_switch;
	private Switch sw_bool_swing;
	private Spinner sp_enum_fan_speed;
	private TextView tv_data_countdown_set;
	private SeekBar sb_data_countdown_set;
	...
	private void initView() {
		...
		sw_bool_switch = (Switch) findViewById(R.id.sw_bool_switch);
		sw_bool_swing = (Switch) findViewById(R.id.sw_bool_swing);
		sp_enum_fan_speed = (Spinner) findViewById(R.id.sp_enum_fan_speed);
		tv_data_countdown_set = (TextView) findViewById(R.id.tv_data_countdown_set);
		sb_data_countdown_set = (SeekBar) findViewById(R.id.sb_data_countdown_set);
	}

	private void initEvent() {

		sw_bool_switch.setOnClickListener(this);
		sw_bool_swing.setOnClickListener(this);
		sp_enum_fan_speed.setSelection(0, false);
		sp_enum_fan_speed.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_fan_speed) {
					sendCommand(KEY_FAN_SPEED, position);
					data_fan_speed = position;
				}
			}
		...
		sb_data_countdown_set.setOnSeekBarChangeListener(this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_switch:
			sendCommand(KEY_SWITCH, sw_bool_switch.isChecked());
			break;
		case R.id.sw_bool_swing:
			sendCommand(KEY_SWING, sw_bool_swing.isChecked());
			break;
		default:
			break;
		}
	...
	public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
		...
		case R.id.sb_data_countdown_set:
			tv_data_countdown_set.setText(formatValue((progress + COUNTDOWN_SET_OFFSET) * COUNTDOWN_SET_RATIO + COUNTDOWN_SET_ADDITION, 1));
			break;
		default:
			break;
		}
	...
	public void onStopTrackingTouch(SeekBar seekBar) {
		switch (seekBar.getId()) {
		case R.id.sb_data_countdown_set:
			sendCommand(KEY_COUNTDOWN_SET, (seekBar.getProgress() + COUNTDOWN_SET_OFFSET ) * COUNTDOWN_SET_RATIO + COUNTDOWN_SET_ADDITION);
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_switch.setChecked(data_switch);
		sw_bool_swing.setChecked(data_swing);
		sp_enum_fan_speed.setSelection(data_fan_speed, true);
		tv_data_countdown_set.setText(data_countdown_set+"");
		sb_data_countdown_set.setProgress((int)((data_countdown_set - COUNTDOWN_SET_ADDITION) / COUNTDOWN_SET_RATIO - COUNTDOWN_SET_OFFSET));
